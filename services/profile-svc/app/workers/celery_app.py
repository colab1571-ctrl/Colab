"""Celery application for profile-svc async workers."""
...
celery_app.conf.update(
    ...
    task_routes={
        "app.workers.ai_review_tasks.*": {"queue": "ai_review"},
        "app.workers.health_score_tasks.*": {"queue": "health_score"},
